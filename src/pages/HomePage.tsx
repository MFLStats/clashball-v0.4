            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-3xl mx-auto">
                {(['1v1', '2v2', '3v3', '4v4'] as GameMode[]).map((mode) => (
                    <button
                        ...
                        className="group relative overflow-hidden p-8 rounded-xl bg-white border border-slate-200 shadow-sm hover:border-haxball-blue hover:shadow-md transition-all duration-200 text-left"
                    >
                        <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
                            <Globe className="w-24 h-24 text-slate-900" />
                        </div>
        ...
        return (
          <div className="flex flex-col items-center justify-center min-h-[60vh] space-y-12 animate-slide-up">
            ...
            <div className="text-center space-y-4">
              <div className="inline-block p-6 rounded-full bg-white shadow-lg border-4 border-slate-100">
